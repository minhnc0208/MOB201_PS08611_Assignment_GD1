package com.example.mob204_ps08611;
...
import com.example.mob204_ps08611.book.ui.HomeActivity;
            ...
            public void onClick(View v) {
                ...
                if (password.length() < 6 || userName.isEmpty() || password.isEmpty()) {
                    ...
                    if (user != null && user.getUserName() != null) {
                        ...
                        Toast.makeText(MainActivity.this, "Bạn chưa có tài khoản", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
